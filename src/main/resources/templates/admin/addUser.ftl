                        ...
                        <div class="row" style="padding-top: 10px;">
                            ...
                            <div class="col-md-8  input-lg">
                                <div class="form-group form-group-lg">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control  input-lg" id="user" placeholder="登录用户名" name="user" />
                                        <input type="text" class="form-control  input-lg" id="pwd" placeholder="登录密码" name="pwd" />
                                    </div>
